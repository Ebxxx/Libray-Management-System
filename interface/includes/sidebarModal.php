    ...
    <div class="p-4 d-flex flex-column h-100">
        ...
        <nav class="nav-menu flex-grow-1">
            <ul class="nav flex-column gap-2">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 text-light rounded py-2 px-3" href="user-management.php">
        ...
        <div class="mt-auto">
            <a class="nav-link d-flex align-items-center gap-2 text-danger rounded py-2 px-3" href="auth/logout.php">
